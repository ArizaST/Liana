function agregarAlCarrito() {
    ...
    let carrito = JSON.parse(localStorage.getItem("carritoJoyeria1")) || [];

    // Ruta de la imagen del producto
    const imagen = "/imagenes/Accesorios/Joyeria1.png"; // Reemplaza con la ruta correcta de la imagen

    // Crear un objeto con los detalles del producto
    const producto = {
        nombre: "ARETE TOPO PANDERO",
        precio: 160.90,
        talla: talla,
        cantidad: cantidad,
    ...
    localStorage.setItem("carritoJoyeria1", JSON.stringify(carrito));
